        ...
        <div id="about">
            ...
            <div className="top-grid">
                <div className="md:col-span-3">
                    <div className="noisy" />
                    <Image src={'/images/abt1.png'} alt="grid-img-1" fill className="img"/>
                </div>

                <div className="md:col-span-6">
                    <div className="noisy" />
                    <Image src={'/images/abt2.png'} alt="grid-img-2" fill className="img"/>
                </div>

                <div className="md:col-span-3">
                    <div className="noisy" />
                    <Image src={'/images/abt5.png'} alt="grid-img-2" fill className="img"/>
                </div>
            ...
            <div className="bottom-grid">
                    <div className="md:col-span-8">
                        <div className="noisy" />
                        <Image src={'/images/abt3.png'} alt="grid-img-3" fill className="img" />
                    </div>
                    <div className="md:col-span-4">
                        <div className="noisy" />
                        <Image src={'/images/abt4.png'} alt="grid-img-4" fill className="img"/>
                    </div>
                </div>
        </div>
    );
